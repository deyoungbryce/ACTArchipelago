...
item_table: Dict[str, ACTItemData] = {
    ...
    # consumable
    iname.barbed_hook: ACTItemData(ItemClassification.filler, 100, 87, "Consumable"), #113 in game
    ...
    sname.soda_can: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.bottle_cap: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.tin_can: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.shot_glass: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.banana_peel: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.party_hat: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.coconut: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.teacup: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.sauce_nozzle: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.thimble: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.bebop_cup: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.tennis_ball: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.f_key: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.mason_jar: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.salt_shaker: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.conchiglie: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.bartholomew: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.disco_ball: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.baby_shoe: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.lil_bro: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.matryoshka_large: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    #sname.matryoshka_medium: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    #sname.matryoshka_small: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.shuttlecock: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.felix_cube: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.piggy_bank: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.trophy: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.imposter: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.lil_red_cup: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.wafer_cone: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.yoccult: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.coffee_pod: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.egg_shell: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.coffee_mug: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.cascadia_roll: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.ham_tin: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.skull: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.crab_husk: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.legal_brick: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.spring: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.shotgun_shell: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.rubber_duck: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.boxing_glove: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.cardboard_box: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.tissue_box: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.valve: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.dumptruck: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.ink_cartridge: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.gacha_capsule: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.lightbulb: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.mouse: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.going_under_64: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.sock: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.doll_head: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.service_bell: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.party_popper: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.scrub_aggie: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.dentures: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.pill_bottle: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.detergent_cap: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.ultrasoft: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.champagne_flute: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.dish_scrubber: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.snow_globe: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    sname.knights_helmet: ACTItemData(ItemClassification.progression, 1, None, "Shells"),
    #sname.spirit_conch: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    sname.plug_fuse: ACTItemData(ItemClassification.progression, 1, None, "Shells")

}
#for name, data in item_table.items(): data.item_id_offset = data.item_id_offset + item_base_id
# def combine_item_id(item: ACTItemData) -> int:
#     if item.item_id_offset == None:
#         return None
#     else:
#         return item.item_id_offset + item_base_id
