...
item_table: Dict[str, ACTItemData] = {
    ...
    # sname.tin_can: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.shot_glass: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.banana_peel: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.party_hat: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.coconut: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.teacup: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.sauce_nozzle: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.thimble: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.bebop_cup: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.tennis_ball: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.f_key: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.mason_jar: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.salt_shaker: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.conchiglie: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.bartholomew: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.disco_ball: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.baby_shoe: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.lil_bro: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.matryoshka_large: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.matryoshka_medium: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.matryoshka_small: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.shuttlecock: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.felix_cube: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.piggy_bank: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.trophy: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.imposter: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.lil_red_cup: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.wafer_cone: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.yoccult: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.coffee_pod: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.egg_shell: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.coffee_mug: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.cascadia_roll: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.ham_tin: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.skull: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.crab_husk: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.legal_brick: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.spring: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.shotgun_shell: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.rubber_duck: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.boxing_glove: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    ...
    # sname.valve: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.dumptruck: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.ink_cartridge: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.gacha_capsule: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.lightbulb: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.mouse: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.going_under_64: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.sock: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.doll_head: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.service_bell: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.party_popper: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.scrub_aggie: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.dentures: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.pill_bottle: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.detergent_cap: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.ultrasoft: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.champagne_flute: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.dish_scrubber: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.snow_globe: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.knights_helmet: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.spirit_conch: ACTItemData(ItemClassification.filler, 1, None, "Shells"),
    # sname.plug_fuse: ACTItemData(ItemClassification.filler, 1, None, "Shells")
