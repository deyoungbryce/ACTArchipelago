...
expired_grove = "Expired Grove" # where the player encounters heikea and topoda
...
secluded_ridge = "The Sands Between - Secluded Ridge" # area in sands that requires mantis punch to access
