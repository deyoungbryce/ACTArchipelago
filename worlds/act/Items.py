...
item_table: Dict[str, ACTItemData] = {
    ...
    # upgrade
    iname.bloodstar_limb: ACTItemData(ItemClassification.useful, 6, "Upgrades", item_base_id+8), # total in game: 25
    iname.heartkelp_sprout: ACTItemData(ItemClassification.useful, 1, "Upgrades", item_base_id+9), # total in game: 7
    ...
    iname.seastar: ACTItemData(ItemClassification.useful, 2, "Stowaways", item_base_id+14),
    ...
    iname.limpet: ACTItemData(ItemClassification.useful, 2, "Stowaways", item_base_id+18),
    ...
    iname.whelk: ACTItemData(ItemClassification.useful, 2, "Stowaways", item_base_id+22),
    ...
    # currency
    iname.breadclaw: ACTItemData(ItemClassification.filler, 16, "Currency", item_base_id+49),
    iname.chipclaw: ACTItemData(ItemClassification.filler, 2, "Currency", item_base_id+50),
